...
<!--Choose section-->
    <section id="choose-1" class="choose bg-grey roomy-80">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 main-portfolio ">
                                ...
                                <br>
                                    <div class="basic-tb-hd">
                                      <center><h3 class="card-title">PERHITUNGAN TAHUN 2016</h3></center>
                                    </div>
                                     <form method="post" action="call_2016.php">
                                        <center><button type="submit" class="btn btn-primary btn-sm" name="insert" value="InsertData">
                                            <i class="fa fa-dot-circle-o"></i> Call Prosedure Tahun 2016
                                        </button></center>
                                    </form>
                                    ...
                                    <tr>
                                      <th scope="col"><center>NO</center></th>
                                        ...
                                        <th scope="col"><center>Banyak</center></th>
                                        <th scope="col"><center>Sedang</center></th>
                                        <th scope="col"><center>Sedikit</center></th>
                                  ...
                                  ?>
                                     ...
                                     <td><center><?php echo @$no; ?></center></td>
                                      ...
                                      <td><center><?php echo @$data[sedikit]; ?></center></td>
                                        ...
                                        <center>
                                            <a href="proses_2016.php?delete=<?php echo $data['id_penjualan'];?>">
